...
<div class="content">
    ...
    <div class="Page">
        ...
        $result = mysqli_query($link, "SELECT * FROM posts ORDER BY `id` DESC LIMIT 0, 5");
        //$count = 0;
        ...
        foreach ($content as $res) {
           ...
           echo '<a href="material.php?id=' . $res['id'] . '"><div class="ChatBlock"><span>Added: ' . $res['data'] . ' by: ' . $_SESSION['LOGIN'] . '  </span> <p class="spanPost">' . $res['name'] . '</p><br>' . $material . '</div></a><button class="de" onclick="redirect(' . $res['id'] . ')">DELETE</button><button class="de"> <a href="editMode.php?type=edit&id=' . $res['id'] . '"> EDIT</a></button>';
//    echo "<div id='.$count.'>" . $res['context'] . "<span>Edit</span><span>Delete</span></div>";
//    $count++;
        }
        ?>
            ...
            <ul>
                ...
                if ($pagination->count_pages() > 1) {
                    if ($pagination->has_previous_page()) {
                        echo "<li><a href=\"adminPage.php?page=";
                        echo $pagination->previous_page();
                        echo "\">&laquo; Previous </a></li>";
                        echo "<li><a href=\"adminPage.php?page=1";
                        echo "\">First</a></li>";
                        if ($page > 2) {
                    ...
                    switch ($page) {
                        case $page:
                        {
                            if ($page == 1) {
                                ...
                                echo " <li class='active'><a href='adminPage.php?page={$p1}'>$p1</a></li>";
                                echo " <li><a href='adminPage.php?page={$p2}'>$p2</a></li>";
                                echo " <li><a href='adminPage.php?page={$p3}'>$p3</a></li>";
                            ...
                            if ($page == 2) {
                                ...
                                $p2--;
                                $p3--;
                                echo " <li><a href='adminPage.php?page={$p1}'>$p1</a></li>";
                                echo " <li class='active'><a href='adminPage.php?page={$p2}'>$p2</a></li>";
                                echo " <li><a href='adminPage.php?page={$p3}'>$p3</a></li>";
                            ...
                            if ($page > $pagesArr[count($pagesArr) - 1]) {
                                ...
                                echo " <li><a href='adminPage.php?page={$p2}'>$p2</a></li>";
                                if ($page == $pagesArr[count($pagesArr)]) {
                                    echo " <li class='active'><a href='adminPage.php?page={$p3}'>$p3</a></li>";
                                } else {
                                    echo " <li><a href='adminPage.php?page={$p3}'>$p3</a></li>";
                                }
                            }
